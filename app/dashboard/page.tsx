    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="glass-card p-8 mb-8">
          ...
          <p className="text-gray-300">Manage your listings and grow your agricultural business</p>
        </div>

        {/* Stats Grid */}
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="glass-card p-6">
            <div className="text-3xl font-bold gradient-text mb-2">{activeListings}</div>
          ...
          <div className="glass-card p-6">
            <div className="text-3xl font-bold gradient-text mb-2">{profile?.listings_remaining || 0}</div>
            <div className="text-gray-300">Listings Remaining</div>
          </div>
          <div className="glass-card p-6">
        ...
        <div className="flex gap-4 mb-8">
          <Link href="/dashboard/add-product" className="btn-primary text-white">
            + Add New Listing
          </Link>
          <Link href="/pricing" className="glass-card px-6 py-3 hover:border-agri-green transition">
            Upgrade Plan
          </Link>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          {products.length === 0 ? (
            <div className="text-center py-12 text-gray-300">
              ...
              <Link href="/dashboard/add-product" className="btn-primary text-white inline-block">
            ...
            <div className="space-y-4">
              {products.map((product) => (
                <div key={product.id} className="glass-card p-6 flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    <Link
                      ...
                      className="px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 rounded-lg transition"
                    >
                      Edit
                    </Link>
                    <button
