              ...
              <div key={product.id} className="glass-card overflow-hidden group">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-xs text-gray-400">{product.province}</span>
                  </div>
                  ...
                  {user ? (
                    <div className="space-y-2 pt-4 border-t border-gray-700">
                      ...
                      <div className="text-sm">
                        ...
                        <a href={`mailto:${product.contact_email}`} className="text-agri-green hover:underline">
                    ...
                    <div className="pt-4 border-t border-gray-700">
                      <Link
                        href="/auth/login"
                        className="block text-center btn-primary text-white text-sm py-2"
                      >
