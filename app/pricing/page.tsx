  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'View count & engagement tracking',
        'Contact info sharing',
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="glass-card p-8 mb-16">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="glass-card p-6">
              <h3 className="font-bold text-lg mb-2">What's included in view count tracking?</h3>
              <p className="text-gray-300">
                All plans include basic view tracking showing how many times your listing has been viewed.
                Starter and Professional plans get access to your dashboard analytics showing total views
                across all your listings and engagement trends.
              </p>
            </div>

            <div className="glass-card p-6">
              <h3 className="font-bold text-lg mb-2">How do featured listings work?</h3>
              <p className="text-gray-300">
                Professional plan listings get a "Featured" badge and appear higher in marketplace search
                results. They're also rotated on the homepage for maximum visibility to potential buyers.
              </p>
            </div>
            ...
            <div className="glass-card p-6">
              <h3 className="font-bold text-lg mb-2">What support do I get?</h3>
              <p className="text-gray-300">
                All users get email support. Starter plan includes priority email support with 24-hour response time.
                Professional plan adds phone support during business hours (8am-5pm SAST, Monday-Friday) with
